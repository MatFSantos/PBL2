...
char INSERT_SQL[] = "INSERT INTO log_node.logs (id, energia, custo) VALUES ('%d', '%f', '%f')";
char query[128];
...
void enviarDados(int id, float energia, float custo);//Enviar dados ao MySQL
...
void enviarDados(int id, float energia, float custo) {
  sprintf(query, INSERT_SQL, id, energia, custo);
